...
def anonymize_names_partb(text: str):
    ...
    for i, word in enumerate(words):
        ...
        elif (i == 6 or i == 5) and word[0].isupper():
            anonymized_text += 'ANON'
        else:
...
if __name__ == '__main__':
    ...
    parta_input_text = [
        ...
        "Norman and Jeff are talking to Jordan about going to the St. Augstine beach."
        ]
    print("Part A")
    for parta_input_text_str in parta_input_text:
        print(f"{parta_input_text_str} -> {anonymize_names_parta(parta_input_text_str)}")
